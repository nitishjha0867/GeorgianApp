 ...
 */
public class FragmentSplash5 extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.fragment_splash5, null);
