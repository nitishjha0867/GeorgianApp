 ...
 */
public class FragmentSchoolMates extends BaseFragment implements View.OnClickListener {

    private Context context;
    private View view;
    private RecyclerView rcyclerSchoolMates;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        view = LayoutInflater.from(context).inflate(R.layout.fragment_schoolmates, null);
        ...
        rcyclerSchoolMates.setHasFixedSize(true);

        // use a linear layout manager
        mLayoutManager = new LinearLayoutManager(context);
        rcyclerSchoolMates.setLayoutManager(mLayoutManager);
        ...
        rcyclerSchoolMates.setAdapter(mAdapter);
    ...
    @Override
    public void findId() {
        rcyclerSchoolMates = (RecyclerView)view.findViewById(R.id.rcyclerSchoolMates);
    }
