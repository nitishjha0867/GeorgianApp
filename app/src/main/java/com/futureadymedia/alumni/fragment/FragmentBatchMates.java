 ...
 */
public class FragmentBatchMates extends BaseFragment implements View.OnClickListener {

    private Context context;
    private View view;
    private RecyclerView rcyclerBatchMates;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        view = LayoutInflater.from(context).inflate(R.layout.fragment_batchmates, null);
        ...
        rcyclerBatchMates.setHasFixedSize(true);

        // use a linear layout manager
        mLayoutManager = new LinearLayoutManager(context);
        rcyclerBatchMates.setLayoutManager(mLayoutManager);
        ...
        rcyclerBatchMates.setAdapter(mAdapter);
    ...
    @Override
    public void findId() {
        rcyclerBatchMates = (RecyclerView)view.findViewById(R.id.rcyclerBatchMates);
    }
